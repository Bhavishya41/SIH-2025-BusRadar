...
const BusTracker = () => {
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center pt-10 overflow-hidden">
      ...
      {/* Dark Overlay */}
      <div 
        className="absolute inset-0 bg-fixed pointer-events-none"
        style={{
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <Link to="/findbuses" className="bg-red-400 backdrop-blur-md border border-white/20 hover:bg-red-500 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 flex items-center space-x-3 group">
                <span>Start Tracking</span>
